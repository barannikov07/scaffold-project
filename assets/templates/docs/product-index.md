...
| {{FIRST_FEATURE_NAME}} | TBD(claude): one line from the interview | 1 | Full | TBD(claude): has-UI · risk tags, set at Assess | Planned | [prd](products/{{FIRST_FEATURE_SLUG}}/prd.md) | [design](products/{{FIRST_FEATURE_SLUG}}/design.md) | [spec](products/{{FIRST_FEATURE_SLUG}}/spec.md) | [guide](products/{{FIRST_FEATURE_SLUG}}/guide.md) | {{DATE}} |
